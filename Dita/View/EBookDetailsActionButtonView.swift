...
struct EBookDetailsActionButtonView: View {
    ...
    var body: some View {
        ...
        if purchased == "yes" {
            ...
            if payment_fullebook_http_manager.requestMade == "0" {
                Button(action: {
                    print("BUY FULL BOOK")
                }) {
                    HStack (spacing: 8) {
...
struct EBookDetailsActionButtonView_Previews: PreviewProvider {
    static var previews: some View {
        EBookDetailsActionButtonView(purchased: "yes", ebook_name: "ebook.book_title", ebook_pdf_url: "https://www.africau.edu/images/default/sample.pdf")
    }
}
